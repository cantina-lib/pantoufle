...
MidiNoteInputLayer::MidiNoteInputLayer(size_u numberVoices) : m_inputNotes() {
...
const MidiNoteInput &MidiNoteInputLayer::getVoice(size_u voice) const {
  return m_inputNotes.at(voice);
}

size_u MidiNoteInputLayer::getNumberVoices() const {
