...
CANTINA_PAN_NAMESPACE_BEGIN
    ...
    MidiNoteInternalLayer::
    MidiNoteInternalLayer(size_u numberVoices)
        : m_internalNotes()
    {
    ...
    void
    MidiNoteInternalLayer::
    receive(const MidiNoteInput& input)
    {
    ...
    void
    MidiNoteInternalLayer::
    setVoice(const MidiNoteInternal&note)
    {
    ...
    MidiNoteInternal&
    MidiNoteInternalLayer::
    getVoiceMutable(size_u voice)
    {
        return m_internalNotes.at(voice);
    }

    const Stream <MidiNoteInternal> &
    MidiNoteInternalLayer::
    getNotes() const
    {
